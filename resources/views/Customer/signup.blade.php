...
<head>
    ...
    <link rel="icon" type="image/png" href="{{url('/public/')}}/img/fav.png">
    <title>Swiggiweb - Online Food Ordering Website Template</title>
    <!-- Slick Slider -->
    <link rel="stylesheet" type="text/css" href="{{url('/public/')}}/vendor/slick/slick.min.css" />
...
<div class="osahan-signup login-page">
    <video loop autoplay muted id="vid">
        <source src="{{url('/public/')}}/img/bg.mp4" type="video/mp4">
        <source src="{{url('/public/')}}/img/bg.mp4" type="video/ogg">
            ...
            <div class="px-5 col-10 mx-auto">
                ...
                <form class="mt-5 mb-4" action="{{ route('register') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter Name" class="form-control" name="name" id="exampleInputName1" aria-describedby="nameHelp">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" placeholder="Enter Email" name="email" class="form-control" id="exampleInputNumber1" aria-describedby="numberHelp">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="text-dark">Địa chỉ</label>
                        <input type="text" placeholder="Enter địa chỉ" name="address" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" placeholder="Enter Password" name="password_confirmation" class="form-control" id="exampleInputPassword1">
                    </div>

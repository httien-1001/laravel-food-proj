        ...
        <div class="px-5 col-md-6 ml-auto">
            <div class="px-5 col-10 mx-auto">
                ...
                <form class="mt-5 mb-4" action="{{route('login')}}" method="post">
                    ...
                    <div class="py-2">
                        <a class="btn btn-lg btn-facebook btn-block" href="{{route('auth.facebook')}}"><i class="feather-facebook"></i> Connect with Facebook</a>

                    </div>
                </form>
                <a href="{{route('user.forget')}}" class="text-decoration-none">

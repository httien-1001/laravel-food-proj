...
@section('content')
    <div class="container">
            ...
            <form method="POST" action="{{route('search.store')}}" >
                ...
                <div class="input-group mb-4 mt-4">
                    <input type="text" class="form-control form-control-lg input_search border-right-0" id="inlineFormInputGroup" value="{{$result}}"
                           name="name"
                    >
    ...
    <div class="most_popular">
        <div class="py-3 title d-flex align-items-center">
            <h5 class="m-0">Kết quả tìm kiếm cho "<i>{{$result}}</i>"</h5>
        </div>
        <div class="row">
...
{{--                                                                    </form>--}}
                            ...
                            <a href="{{route('detail.view',$pr->id)}}" style="display: inline-block; height: 165px">
                                <img alt="#" src="{{url('/public/')}}{{$pr->img}}" class="img-fluid item-img w-100">
                            </a>
                        </div>
                        <div class="p-3 position-relative">
                            <div class="list-card-body">
                                ...
                                <p class="text-info"
                                   style="font-size: 1.3rem">{{number_format($pr->price) . ' VNĐ'}}</p>
    ...
    @else
        ...
        <div class="container osahan-coming-soon py-5 d-flex justify-content-center align-items-center">
            <div class="osahan-text text-center">
                ...
                <h2 class="text-primary mb-3 font-weight-light">Không có sản phẩm như bạn tìm kiếm!</b></h2>
